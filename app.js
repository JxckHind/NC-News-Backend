...
const app = express();
const { getTopics, getArticles, getArticlesById, getCommentsById, postNewComment, updateArticleVotes, getUsers, getComments, deleteCommentById } = require("./controllers/news-controllers");
